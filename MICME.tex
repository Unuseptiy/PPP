...
\begin{references}
\refitem{wiki}
Энциклопедия Wikipedia [Электронный ресурс] / Режим доступа: http://ru.wikipedia.org/wiki/
\refitem{PyTorch}
